...
void CWF3DTest(const std::filesystem::path& exe_path, int Nums = 900, std::string file = "mobius1")
{
    namespace fs = std::filesystem;
...
int main(int argc, char** argv)
{
    ...
    std::string model = (argc >= 3) ? argv[2] : "mobius1";
    int N = (argc >= 4) ? std::max(1, std::atoi(argv[3])) : 900;
